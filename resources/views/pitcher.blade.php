...
　　  <h2>大学名</h2>
　　            
　　   <select class="form-select" name="picher[uniname]"aria-label="Default select example" value="{{old('picher.uniname')}}">
...
　　      <input class="form-control" type="text" name="picher[pichername]"  aria-label="default input example" placeholder="名前を入力 年も入力" value="{{old('picher.pichername')}}">
　　      <p class="pichername_error" style="color:red">{{$errors->first('picher.pichername')}}</p>
　　</div>     
　　<div class="handedness">
　　  <h2 class="text-center">利き手</h2>
　　  <input class="form-control" type="text" name="picher[handedness]" placeholder="右投げor左投げ"aria-label="default input example" value="{{old('picher.handedness')}}">
　　  <p class="handedness_error" style="color:red">{{$errors->first('picher.handedness')}}</p>
　  </div>
　　        
　　<div class="quick">
　　      <h2 class="text-center">クイックタイム</h2>
　　    　<input class="form-control" type="number" name="picher[quick]" placeholder="クイックタイムを入力"aria-label="default input example" value="{{old('picher.quick')}}">
